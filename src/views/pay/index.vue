    ...
    <div class="address" @click="$router.push('/address')">
      ...
      <div class="info" v-if="true">
        <div class="info-content">
          <span class="name" v-if="selectAddress">{{ selectAddress.name }}</span>
          <span class="mobile" v-if="selectAddress">{{ selectAddress.phone }}</span>
        </div>
        <div class="info-address" v-if="selectAddress">
          {{ longAddress }}
        </div>
      </div>
